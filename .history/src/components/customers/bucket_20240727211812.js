            ...
            selector: row => {
                if (rulesName == 'sales') {
                    if (row.flagging_check === 1) {
                        ...
                        return <button className={`btn btn-sm btn-warning`} onClick={(event) => handleOpenKlaim(row)}>
                            Pending Klaim
                        </button>
                    } else {
                        return <button className={`btn btn-sm btn-secondary`} onClick={(event) => handleOpenKlaim(row)}>
                            Pending Share
                        </button>
                    }
                } else {
