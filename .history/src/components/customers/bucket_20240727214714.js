                                ...
                                <div className="d-flex align-items-center mb-2">
                                    <div className="flex-grow-1 overflow-hidden">
                                        <input
                                            ...
                                            style={{ width: "20%" }}
                                        />
                                        <i><small className="text-danger">Segera klaim customer sebelum melebihi tanggal expired</small></i><br></br>
                                    ...
                                    <div className="flex-shrink-0">
                                        <div id="" className='p-2'>
                                            <button onClick={handleTerapkan} type="button" className="btn btn-sm btn-primary"><i className=" ri-user-search-line"></i> History Klaim</button>
                                        </div>
                                    </div>
                                </div>
                                {loadingTable ? (
