...
function Bucket() {
    ...
    const getHistoryKlaim = async () => {
        const url = `http://127.0.0.1:8000/api/bucket/history?id_cabang=${inputCabang}&statusklaim=${filterStatus}`;
        try {
            const response = await axios.get(url);
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select id="statusklaim" className="form-control form-select" name="statusklaim" defaultValue={filterStatus}>
