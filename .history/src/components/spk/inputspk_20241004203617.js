                                ...
                                <div className="row">
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" onChange={handleChangeInput} value={setArrInput.nama_customer} name="nama_customer" id="nama_customer" placeholder="" required />
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="number" className="form-control form-control-sm" disabled onChange={handleChangeInput} value={setArrInput.nama_customer} name="no_telp" id="no_telp" placeholder="" required />
