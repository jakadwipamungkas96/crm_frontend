        ...
        },
        {
            ...
            selector: row => {
                if (row.afi_status === "approve") {
                    ...
                    return <>
                            <div className="btn-group btn-group-sm" style={{cursor: "not-allowed"}} disabled role="group" aria-label="Basic example">
                                <button type="button" className="btn btn-info btn-sm"><i className="ri ri-pencil-line"></i> Edit</button>
                            </div>
                        </>
                ...
                <Fade in={openEditSpk}>
                    <Box sx={style}>
                        ...
                        <div className="row mb-3">
                            <div className="row mb-2">
                                <div className="col-lg-6 col-md-6">
                                    <select className="form-control" name="is_active" value={isActive} onChange={handleIsActiveSpk}>
