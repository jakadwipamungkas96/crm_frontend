                        ...
                        <div className='card-body'>
                            <div className='row'>
                                <div className='col-md-6 ml-2 mb-5'>
                                    <input type="text" class="form-control form-control-sm" onChange={handleChangeNamaCustomer} value={NamaCustomer} id="basiInput" />
                                </div>
                                <div className='col-md-6 mb-5'>
                                    <button type="button" class="btn btn-sm btn-primary" onClick={handleSearchCustomer}>Search</button>
                                </div>
