                ...
                <Fade in={openPengajuanCancel}>
                    <Box sx={style}>
                        ...
                        <div className="btn-group btn-group-md mt-5" role="group" aria-label="Basic example">
                            <button type="button" onClick={handleClosePengajuan} className="btn btn-light btn-sm"><i className="ri ri-close-line"></i> Cancel</button>
                            <button type="button" onClick={handleSubmitPengajuanCancel} className="btn btn-danger btn-sm"><i className="ri ri-check-line"></i> Delete</button>
                        </div>
                    </Box>
                </Fade>
            </Modal>
