                        ...
                        <div className="card">
                            ...
                            <div className="card-body" style={{ padding: "15px" }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" onChange={handleChangeInput} value={arrInput.nama_customer} name="customer_name" id="customer_name" placeholder="" required />
