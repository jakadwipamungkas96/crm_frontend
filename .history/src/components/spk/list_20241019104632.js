...
function List() {
    ...
    cost [detailSpk, setDetailSpk] = useState([]);
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-12 col-md-12 text-end">
                                <div className="btn-group btn-group-md" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" onClick={handleSubmitEditSpk} className="btn btn-success btn-sm" disabled={showbtn}><i className="ri ri-check-double-fill"></i> Kirim Pengajuan</button>
                                </div>
                            </div>
                        </div>
                    </Box>
