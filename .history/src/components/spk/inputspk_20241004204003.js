                        ...
                        <div className="card">
                            ...
                            <div className="card-body" style={{ padding: "15px" }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="number" className="form-control form-control-sm" disabled onChange={handleChangeInput} value={arrInput.no_telp} name="no_telp" id="no_telp" placeholder="" required />
