                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <div className="row">
                                ...
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div class="form-floating">
                                        <input type="number" class="form-control form-control-sm" id="no_telp" placeholder="" required />
                                        <label for="no_telp">Nomor Telepon</label>
                                    </div>
                                </div>
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div class="form-floating">
                                        <input type="date" class="form-control form-control-sm" id="no_telp" placeholder="" required />
                                        <label for="no_telp">Nomor Telepon</label>
                                    </div>
                                </div>
                            </div>
