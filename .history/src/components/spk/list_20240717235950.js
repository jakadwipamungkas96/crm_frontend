                        ...
                        <div className='card-body'>
                            <div className='row'>
                                <div className='col-md-6 ml-2 mb-5'>
                                    <input type="text" placeholder='search nama customer' className="form-control form-control-sm" name="namacustomer" onChange={handleChangeNamaCustomer} value={NamaCustomer} id="basiInput" />
                                </div>
