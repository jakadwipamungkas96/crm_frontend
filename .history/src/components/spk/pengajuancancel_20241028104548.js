...
function Pengajuancancel() {
    ...
    const handleSubmitValidasi = async () => {
        ...
        try {
            ...
            const response = await axios.post(`https://api.crm.wijayatoyota.co.id/api/spk/pengajuan/validasi`, arrPengajuan);
            ...
            selector: row => {
                if (rulesName === "stock") {
                    if (row.status_pengajuan_cancel === 'waiting') {
                        return <><button type='button' onClick={() => {showApprove(row.id, row.no_spk, row.reason_cancel)}} className='btn btn-sm btn-info'><i className="ri ri-more-fill"></i> Validasi Pengajuan</button></>
                    } else {
                        return <><button type='button' disabled className='btn btn-sm btn-info'><i className="ri ri-more-fill"></i> Validasi Pengajuan</button></>
                    }
                }
            },
            sortable: true,
        ...
        },
        {
            ...
            selector: row => {
                if (row.status_pengajuan_cancel === 'waiting') {
                    ...
                    return <><span className="sticky-column badge badge-label bg-danger"><i className="mdi mdi-circle-medium"></i> Rejected</span></>
                } else if (row.status_pengajuan_cancel === 'approve') {
                    return <><span className="sticky-column badge badge-label bg-success"><i className="mdi mdi-circle-medium"></i> Approved</span></>
                } 
            },
            sortable: true,
            width: '150px',
                                            ...
                                            <div className="row mt-2">
                                                <div className="col-12">
                                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                                        <h4 className="mb-sm-0">List Pengajuan Cancel SPK</h4>
                    ...
                    <Box sx={style}>
                        <div className="row mb-3">
                            ...
                            <div className="col-lg-12 col-md-12 mt-3">
                                <span className='mt-2'><b>NO SPK:</b> <br /></span>
                                <span className='mt-2'>{approveNoSpk}</span><br></br>
                                <span className='mt-2'><b>Reason Pengajuan Cancel:</b> <br /></span>
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-12 mb-3">
                                <div className="form-floating">
                                    <select type="text" className="form-control form-control-sm form-select" onChange={handleChangeInput} name="validasi_pengajuan" id="validasi_pengajuan" placeholder="" required>
                                        <option value={""}>-- Pilih Status --</option>
                                        <option value={"approve"}>Approve</option>
                                        <option value={"reject"}>Reject</option>
                                    </select>
                                    <label htmlFor="validasi_pengajuan">Silahkan Pilih Status</label>
                                </div>
                            </div>
