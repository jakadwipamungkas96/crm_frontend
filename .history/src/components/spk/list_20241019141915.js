                            ...
                            <div className="row mb-2">
                                ...
                                {isActive == 1 ?
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        ...
                                        <select className="form-control" name="no_spk" onChange={handleSelectChangeModel} value={selectedModel}>
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" onChange={handleChangeInput} value={suffix} name="suffix" id="suffix" placeholder="" required />
