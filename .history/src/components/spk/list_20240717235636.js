...
function List() {
    ...
    const handleSearchCustomer = () => {
        ...
        axios.post('http://127.0.0.1:8000/api/spk/search', ["nama_customer" = NamaCustomer]).then(function(response){
                        ...
                        <div className='card-body'>
                            <div className='row'>
                                <div className='col-md-6 ml-2 mb-5'>
                                    <input type="text" placeholder='search nama customer' className="form-control form-control-sm" onChange={handleChangeNamaCustomer} value={NamaCustomer} id="basiInput" />
                                </div>
