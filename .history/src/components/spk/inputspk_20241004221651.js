...
function Inputspk() {
    ...
    const spvid = JSON.parse(localStorage.getItem("spv_id"));
                                ...
                                <div className="row">
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" onChange={handleChangeInput} value={cabang} name="outlet_name" id="outlet_name" placeholder="" required />
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" onChange={handleChangeInput} value={personName} name="spv_id" id="spv_id" placeholder="" required />
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            ...
                                            <label htmlFor="trade_in_required">Trade IN Required</label>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
