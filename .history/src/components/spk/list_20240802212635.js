                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <div className="row">
                                ...
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div className="form-floating">
                                        <input type="text" className="form-control form-control-sm" id="no_spk" placeholder="" required />
                                        <label htmlFor="no_spk">Nomor SPK</label>
                                    </div>
                                </div>
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div className="form-floating">
                                        <input type="date" className="form-control form-control-sm" id="tgl_spk" placeholder="" required />
                                        <label htmlFor="tgl_spk">Tanggal SPK</label>
                                    </div>
                                </div>
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div className="form-floating">
                                        <input type="date" className="form-control form-control-sm" id="nama_stnk" placeholder="" required />
                                        <label htmlFor="nama_stnk">Nama STNK</label>
                                    </div>
                                </div>
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div className="form-floating">
                                        <input type="number" className="form-control form-control-sm" id="no_telp" placeholder="628xxxxxx" required />
                                        <label htmlFor="no_telp">Nomor Telepon</label>
                                    </div>
                                </div>
                                <div className='col-md-6 ml-2 mb-2'>
                                    <div className="form-floating">
                                        {/* <select type="text" className="form-select form-control-sm" id="tipe" placeholder="" required>
                                            <option value={"all"}>All</option>
                                        </select>
                                        <label htmlFor="tipe">Pilih Kendaraan</label> */}
                                        <Select2
                                            data={optionsModel}
