                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-2">
                                        ...
                                        <Select2
                                            ...
                                            value={arrInput.sales_id} // Sinkronkan dengan state arrInput.sales_id
                                            onChange={(e) => setArrInput(prevState => ({
                                                ...prevState, 
                                                sales_id: e.target.value // Perbarui sales_id di state saat opsi berubah
                                            }))}
                                            name="id_sales"
                                            options={{
                                                placeholder: 'All',
