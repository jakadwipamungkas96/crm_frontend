...
function Inputspk() {
    ...
    const getWarnaKendaraan = async () => {
        const url = `http://127.0.0.1:8000/api/stock/warna?car=${selectedModel}`;
        try {
                        ...
                        <div className="card">
                            ...
                            <div className="card-body" style={{ padding: "15px" }}>
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="text" className="form-control form-control-sm" id="nama_stnk" placeholder="" required />
                                            <label htmlFor="nama_stnk">Nama STNK</label>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="number" className="form-control form-control-sm" id="no_telp" placeholder="" required />
