                            ...
                            <div className="row mb-2">
                                <div className="col-lg-6 col-md-6">
                                    <div class="form-floating">
                                        <input type="text" className="form-control" name="no_spk" onChange={handleSearchSpk} value={no_spk} id="no_spk" />
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-12 col-md-12 text-end">
                                <div className="btn-group btn-group-md" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" onClick={showModalCancel} className="btn btn-success btn-sm disabled"><i className="ri ri-check-double-fill"></i> Kirim Pengajuan</button>
                                </div>
                            </div>
                        </div>
                    </Box>
