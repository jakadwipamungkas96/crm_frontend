...
function List() {
    ...
    const handleSearchSpk = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`https://api.crm.wijayatoyota.co.id/api/spk/findspk`, arrNoSpk);
    ...
    const handleSubmitPengajuanCancel = async () => {
        ...
        if (arrPengajuan.reason_cancel == "") {
            ...
            try {
                ...
                const response = await axios.post(`https://api.crm.wijayatoyota.co.id/api/spk/pengajuan/cancel`, arrPengajuan);
    ...
    const handleSubmitEditSpk = async () => {
        ...
        try {
            ...
            const response = await axios.post(`https://api.crm.wijayatoyota.co.id/api/spk/change_status`, arrEditSpk);
