                                        ...
                                        <div className="card-header" style={{ border: "none" }}>
                                            <div className="d-flex align-items-center">
                                                <div className="flex-grow-1 overflow-hidden">
                                                    <h5 className="card-title mb-0" style={{ fontSize: "17px" }}>Input SPK</h5>
                                                </div>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-2 mb-2">
                                                                <div className="form-floating">
                                                                    <input type="text" className="form-control form-control-sm" defaultValue={""} name="single_id" id="single_id" placeholder="single_id" />
                                                                    <label htmlFor="single_id">Search Single ID</label>
                                                                </div>
                                                            </div>
                                                            <div className="col-lg-6 mb-2">
                                                                <div className="form-floating">
                                                                    <input type="text" className="form-control form-control-sm" defaultValue={""} name="single_id" id="single_id" placeholder="single_id" />
                                                                    <label htmlFor="single_id">Search Single ID / Nama Customer</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <div className="row mt-3">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="text-end">
                                                        <button onClick={handleSubmitSpk} className="btn btn-primary btn-label btn-sm" ><i className="ri-save-3-line label-icon align-middle fs-16 me-2"></i> Save</button>
                                                        <button onClick={closeModalSpk} className="btn btn-danger btn-label btn-sm" style={{ marginLeft: "5px" }}><i className="ri-close-circle-line label-icon align-middle fs-16 me-2"></i> Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
