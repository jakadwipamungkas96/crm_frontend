...
const Login = () => {
    ...
    const handleSubmit = (event) => {
        ...
        .then(response => {
            ...
            localStorage.setItem('cabang', response.data.cabang);
            localStorage.setItem('uid', response.data.uid);
            localStorage.setItem('sid', JSON.stringify(response.data.sid));
            localStorage.setItem('spvid', JSON.stringify(response.data.spvid));
            ...
            } else if (response.data.rules == "do") {
                window.location.href = "/validasi/do";
            } else if (response.data.rules == "afi") {
                window.location.href = "/validasi/afi";
            }
            // window.location.href = "/dashboard";
