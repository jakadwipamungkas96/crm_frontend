                                            ...
                                            <div className="tab-pane active" id="import" role="tabpanel">
                                                ...
                                                <div className="row mt-3">
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        {/* <input class="form-control" type="file" id="formFile" name="filestocks" onChange={handleChooseFileStocks} value={fileUpload} /> */}
                                                        <TextField
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        <select class="form-select mb-3" aria-label="Default select example" onChange={handleKategoriStock}  defaultValue="" value={kategoriStock}>
                                                    ...
                                                    <div className="col-md-12 text-end">
                                                        <button type="button" class="btn btn-sm btn-primary waves-effect waves-light" onClick={handleUploadStock}>Simpan</button>
                                                    </div>
                                                ...
                                                <div className="row mt-3">
                                                        ...
                                                        <div class="col-md-6 mt-2">
                                                            <div class="">
                                                                ...
                                                                <select type="text" class="form-control" name="cabang" id="cabang" defaultValue="" required>
                                                    ...
                                                    <div className="col-md-12 text-end">
                                                        <button type="button" class="btn col-md-12 btn-sm btn-primary waves-effect waves-light" onClick={handleSubmitStock}>Simpan</button>
                                                    </div>
