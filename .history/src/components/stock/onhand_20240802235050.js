            ...
            >
                <Fade in={openDelete}>
                    <Box sx={style}>
                        ...
                        <h4>Apakah anda yakin akan menghapus stock kendaraan <b>{modelstock}</b> ini ?</h4>
                        <div className="btn-group btn-group-md mt-5" role="group" aria-label="Basic example">
                            ...
                            <button type="button" onClick={handleDeleteCar} className="btn btn-success btn-sm"><i className="ri ri-check-line"></i> Delete</button>
                        </div><br></br>
                        <span className='text-small'>Data yang sudah terhapus tidak akan bisa dikembalikan !</span>
                    </Box>
                </Fade>
            </Modal>
        </div>
