            ...
            selector: row => {
                return <>
                        <div className="btn-group btn-group-sm" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-info"><i className="ri ri-calendar-todo-fill"></i> Edit</button>
                            <button type="button" className="btn btn-success"><i className="ri ri-checkbox-circle-fill"> </i>Delete</button>
                        </div>
                    </>
            },
            sortable: true,
