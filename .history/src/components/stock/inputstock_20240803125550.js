                                    ...
                                    <div className="col-md-12">
                                        <div className="tab-content text-muted">
                                            <div className="tab-pane active" id="import" role="tabpanel">
                                                <a target='_blank' href='resources/template/template_stock_do_tam.xlsx' type="button" className="btn btn-outline-success waves-effect waves-light">Download Template Excel</a>
