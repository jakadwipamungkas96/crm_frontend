                    ...
                    <Box sx={style}>
                        ...
                        <div className="row mb-2">
                            <div className="col-lg-6 col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="model" defaultValue={arrEdit.model} id="model" placeholder="Enter your firstname" />
                        ...
                        <div className="row">
                            <div className="col-lg-12 text-end col-md-12">
                                <div className="btn-group btn-group-md" role="group" aria-label="Basic example">
                                    <button type="button" className="btn btn-secondary btn-sm"><i className="ri ri-pencil-line"></i> Cancel</button>
                                    <button type="button" className="btn btn-success btn-sm"><i className="ri ri-pencil-line"></i> Simpan</button>
                                </div>
                            </div>
                        </div>
                    </Box>
