...
function List() {
  ...
  const getNoSpk = async () => {
    const url = `https://api.crm.wijayatoyota.co.id/api/spk/option/no_spk`;
    try {
          ...
          },
          {
            ...
            selector: (row) => {
              if (row.is_active === 1) {
                ...
                return (
                  <>
                    <span className="sticky-column badge badge-label bg-warning">
                      <i className="mdi mdi-circle-medium"></i> Confirmation
                    </span>
                  </>
                );
              } else {
                return (
                  <>
                    <span className="sticky-column badge badge-label bg-danger">
                      <i className="mdi mdi-circle-medium"></i> Inactive
                    </span>
                  </>
                );
              }
            ...
            selector: (row) => {
              if (row.do_internal_status === "waiting") {
                ...
                return (
                  <>
                    <span className="sticky-column badge badge-label bg-danger">
                      <i className="mdi mdi-circle-medium"></i> Reject
                    </span>
                  </>
                );
              }
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      >
                        <i className="ri ri-pencil-line"></i> Edit
                      </button>
                    </div>
                  </>
                );
  ...
  const handleSearchSpk = async (event) => {
    ...
    try {
      const response = await axios.post(
        `https://api.crm.wijayatoyota.co.id/api/spk/findspk`,
        arrNoSpk
      );
  ...
  const handleSubmitPengajuanCancel = async () => {
    ...
    if (arrPengajuan.reason_cancel == "") {
      ...
      try {
        const response = await axios.post(
          `https://api.crm.wijayatoyota.co.id/api/spk/pengajuan/cancel`,
          arrPengajuan
        );
  ...
  const handleSubmitEditSpk = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.crm.wijayatoyota.co.id/api/spk/change_status`,
        arrEditSpk
      );
  ...
  const getWarnaKendaraan = async (norangka) => {
    const url = `https://api.crm.wijayatoyota.co.id/api/stock/warna?car=${selectedModel}&no_rangka=${norangka}`;
    try {
      const response = await axios.get(url);
  ...
  const getNoRangka = async (modelcar) => {
    const url = `https://api.crm.wijayatoyota.co.id/api/stock/norangka?car=${modelcar}`;
    try {
      const response = await axios.get(url);
                    ...
                    >
                      {rulesName == "spv" ? (
                        <>
                          <button
                            type="button"
                            onClick={showModalSpk}
                            className="btn btn-primary btn-sm"
                          >
                            <i className="ri ri-pencil-line"></i> Tambah SPK
                          </button>
                          <button
                            type="button"
                          ...
                          >
                            <i className="ri ri-file-edit-fill"></i> Pengajuan
                            Cancel SPK
                          </button>
                        </>
                      ) : (
            ...
            <div className="row mt-3">
              <div className="col-lg-12 col-md-12 text-end">
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={handleSubmitPengajuanCancel}
                    className="btn btn-success btn-sm"
                    disabled={showbtn}
                  >
                    <i className="ri ri-check-double-fill"></i> Kirim Pengajuan
                  </button>
                </div>
              </div>
            </div>
        ...
        <Fade in={openEditSpk}>
          <Box sx={style}>
            <div className="row mb-3">
              <div className="col-lg-6 col-md-6">
                <h5>
                  Edit SPK <strong>{detailSpk.no_spk}</strong>
                </h5>
              </div>
              <div className="col-lg-6 col-md-6 text-end">
                <button
                  type="button"
                  onClick={handleCloseEditSpk}
                  className="btn btn-light btn-sm"
                >
                  <i className="ri-close-line"></i>
                </button>
              ...
              <div className="row mb-2">
                <div className="col-lg-12 col-md-12 mb-3">
                  {rulesName === "spv" ? (
                    ...
                    <>
                      <label>Pilih Status Approve/Reject</label>
                      <select
                        className="form-control form-select"
                        name="is_active"
                        value={isActive}
                ...
                {isActive == 1 && detailSpk.is_active == 0 ? (
                  <>
                    ...
                    <div className="col-lg-12 col-md-12 mb-2">
                      ...
                      {/* <select
                        ...
                        value={arrEditSpk.katashiki_suffix}
                      >
                        <option value={""}>-- Pilih --</option>
                      ...
                      <div className="form-floating">
                        <input
                          ...
                          required
                        />
                        <label htmlFor="katashiki">Katashiki</label>
                      </div>
                    </div>
                    <div className="col-lg-12 col-md-12 mb-2">
                      <label>Suffix</label>
            ...
            <div className="row mt-3">
              <div className="col-lg-12 col-md-12 text-end">
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={handleSubmitEditSpk}
                    className="btn btn-success btn-sm"
                  >
                    <i className="ri ri-check-double-fill"></i> Save
                  </button>
                </div>
              </div>
            </div>
