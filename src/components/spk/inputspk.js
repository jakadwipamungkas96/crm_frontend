...
function Inputspk() {
    ...
    const getCodeWarna = async (color) => {
        const url = `https://api.crm.wijayatoyota.co.id/api/stock/code_color?color=${color}`;
        try {
            ...
            if (response.data.status === 'ok') {
                setArrInput((prevInput) => ({
                    ...prevInput,
                    ["color_code"]       : response.data.code.code
                }));
            }
    ...
    const fetchCustomers = async (query) => {
        const url = `https://api.crm.wijayatoyota.co.id/api/spk/search?q=${query}`;
        try {
    ...
    async function handleTerapkan() {
        setLoading(true);
        const url = `https://api.crm.wijayatoyota.co.id/api/spk/search?q=${filterSingleId}`;
        try {
                        ...
                        <div className="card">
                            ...
                            <div className="card-body" style={{ padding: "15px" }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <div className="form-floating">
                                            <input type="number" className="form-control form-control-sm" onChange={handleChangeInput} value={arrInput.no_telp} name="no_telp" id="no_telp" placeholder="" required />
